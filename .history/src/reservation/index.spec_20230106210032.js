...
jest.mock('./reservation2.service', () => ({
...
const { getReservedTickets } = require('./reservation2.service');
const { createNewReservation } = require('./reservation.service');
...
describe('Main', () => {
    ...
    test('Expected Reservation Response', async () => {
        const response = await request(BASE_URL).get('/reservation?id=1a44ff66-a942-48f4-a9c1-77184c4469cb')
