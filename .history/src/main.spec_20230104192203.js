...
const BASE_URL = 'https://reservation-new.vercel.app/api/reservation'
...
const { getReservedTickets } = require('./reservation/reservation2.service');
...
describe('Main', () => {
    ...
    test('Expected Reservation Response', async () => {
        const response = await request(BASE_URL).get('?id=d86d3b54-fdc1-414d-96dd-d3dfd33fc74c')
    ...
    test('No Reservation Response', async () => {
        ...
        const response = await request(BASE_URL).get('?id=d34566-fgc2-478f-86ff-d3dfd33fc74c')
